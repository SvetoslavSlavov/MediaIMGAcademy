...
<header>
	...
	<div id="center-menu">
		...
		<ul id="nav"class="nav-hide">
			...
			<li><a href="<?php bloginfo('template_directory');?>/lifestyle/allarticles.html">Лайфстайл</a></li>
			<li><a href="<?php bloginfo('template_directory');?>/sport.php">Спорт</a></li>
			<li><a href="<?php bloginfo('template_directory');?>/#">Моята Новина</a></li>
			<li><a href="<?php bloginfo('template_directory');?>/#">Камерите</a></li>
